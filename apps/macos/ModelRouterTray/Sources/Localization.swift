...
enum RouterChineseText {
  static let values: [String: String] = [
    ...
    "command.lifecycle.status": "生命周期 · 状态",
    "command.lifecycle.start": "生命周期 · 启动",
    "command.lifecycle.stop": "生命周期 · 停止",
    "command.lifecycle.restart": "生命周期 · 重启",
    "command.lifecycle.logs": "生命周期 · 日志",
    "command.doctor.status": "诊断 · 状态",
    "command.doctor.fix": "诊断 · 修复",
    "command.maintenance.update": "维护 · 更新",
    "command.maintenance.rollback": "维护 · 回滚",
    "command.native.status": "原生会话 · 状态",
    "command.native.account-usage": "原生会话 · 账户用量",
    "command.credential.status": "凭据 · 状态",
    "command.credential.set": "凭据 · 设置",
    "command.credential.remove": "凭据 · 移除",
    "command.provider.enable": "提供商 · 启用",
    "command.model.visibility": "模型 · 可见性",
    "command.model.canary": "模型 · 金丝雀",
    "command.protocol-proof.status": "协议验证 · 状态",
    "command.protocol-proof.verify": "协议验证 · 验证",
    "command.protocol-proof.revoke": "协议验证 · 撤销",
    "command.picker.status": "选择器 · 状态",
    "command.picker.set": "选择器 · 设置",
    "command.picker.show-all": "选择器 · 显示全部",
    "command.catalog.status": "目录 · 状态",
    "command.catalog.render-snippet": "目录 · 生成片段",
    "command.subagents.status": "子代理 · 状态",
    "command.subagents.mode": "子代理 · 模式",
    "command.subagents.model": "子代理 · 模型",
    "command.subagents.selection": "子代理 · 选择",
    "command.subagents.verify": "子代理 · 验证",
    "command.failover.status": "故障转移 · 状态",
    "command.failover.reset": "故障转移 · 重置",
    "command.tool-result-aging.status": "工具结果老化 · 状态",
    "command.tool-result-aging.on": "工具结果老化 · 开启",
    "command.tool-result-aging.off": "工具结果老化 · 关闭",
    "command.tool-result-aging.ttl": "工具结果老化 · 保留期限",
    "command.tool-result-aging.purge": "工具结果老化 · 清理",
    "command.usage.router": "用量 · 路由",
    "command.usage.provider": "用量 · 提供商",
    "command.usage.model": "用量 · 模型",
    "command.vision.status": "视觉桥接 · 状态",
    "command.vision.on": "视觉桥接 · 开启",
    "command.vision.off": "视觉桥接 · 关闭",
    "command.vision.engine": "视觉桥接 · 引擎",
    "command.vision.effort": "视觉桥接 · 推理力度",
    "command.vision.probe": "视觉桥接 · 探测",
    "command.vision.pull": "视觉桥接 · 拉取",
    "command.vision.purge-cache": "视觉桥接 · 清理缓存",
    "command.presence.status": "驻留方式 · 状态",
    "command.presence.mode": "驻留方式 · 模式",
    "command.cc-switch.status": "CC Switch · 状态",
    "command.cc-switch.snippet": "CC Switch · 片段",
    "Select": "选择",
  ]
}
